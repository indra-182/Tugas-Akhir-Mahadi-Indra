...
CREATE TABLE penilaian (
  ...
  CONSTRAINT uq_karyawan_kriteria UNIQUE (id_karyawan, id_kriteria)
) ENGINE=InnoDB;
...
('K005', 'Eka Febriani', 'Marketing', 'Koordinator', '2022-05-05', 'AKTIF'),
...
('K015', 'Oktavia Susanto', 'Marketing', 'Staff', '2018-03-15', 'AKTIF'),
...
('K025', 'Zainal Kurniawan', 'Marketing', 'Officer', '2021-01-25', 'AKTIF'),
...
('K035', 'Kevin Pertiwi', 'Marketing', 'Admin', '2024-11-08', 'AKTIF'),
...
('K045', 'Vicky Santoso', 'Marketing', 'Supervisor', '2020-09-18', 'AKTIF'),
...
('K055', 'Eka Febriani', 'Marketing', 'Senior Staff', '2023-07-01', 'AKTIF'),
...
('K065', 'Oktavia Susanto', 'Marketing', 'Analyst', '2019-05-11', 'AKTIF'),
...
('K075', 'Zainal Kurniawan', 'Marketing', 'Koordinator', '2022-03-21', 'AKTIF'),
...
('K085', 'Kevin Pertiwi', 'Marketing', 'Staff', '2018-01-04', 'AKTIF'),
...
('K095', 'Vicky Santoso', 'Marketing', 'Officer', '2021-11-14', 'AKTIF'),
...
('C5', 'Absensi', 0.1500, 'COST', 'Jumlah hari tidak masuk kerja dalam periode penilaian.');
